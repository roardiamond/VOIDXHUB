...
function injectNav() {
  ...
  if (user) {
    ...
    rightHtml = `
      <a href="login.html" style="color:#67e8f9;text-decoration:none;font-size:13px;font-weight:700;margin-right:12px;">Login</a>
      <a href="register.html" style="background:linear-gradient(to right,#06b6d4,#a855f7);color:#000;padding:6px 14px;border-radius:8px;text-decoration:none;font-size:12px;font-weight:700;">Register</a>
    `;
  }
